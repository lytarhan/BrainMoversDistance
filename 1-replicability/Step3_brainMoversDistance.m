...
% NB: to run this script, make sure to install the Gurobi optimizer on your
% machine (https://www.gurobi.com/documentation/quickstart.html). An
% academic license can be obtained at no cost. 

% This script takes a long time to run (up to 24 hours on my PC). I suggest
% letting it run over the weekend.
